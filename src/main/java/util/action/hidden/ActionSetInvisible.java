...
public final class ActionSetInvisible extends BaseAction
{
    ...
    public ActionSetInvisible(final SiteType type, final int to, final int level, final int who) {
        this.who = who;
        this.to = to;
        this.level = level;
        this.type = type;
    ...
    public ActionSetInvisible(final String detailedString) {
        assert detailedString.startsWith("[SetInvisible:");
    ...
    public Action apply(final Context context, final boolean store) {
        ...
        if (this.level != -1) {
            cs.setInvisibleCell(context.state(), this.to, this.level, this.who);
        }
        else {
            cs.setInvisible(context.state(), this.to, this.who, this.type);
        }
        return this;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ActionSetInvisible)) {
            return false;
        }
        final ActionSetInvisible other = (ActionSetInvisible)obj;
    ...
    public ActionType actionType() {
        return ActionType.SetInvisible;
    }
}
