...
public final class SetVar extends Effect
{
    ...
    public SetVar(@Opt final IntFunction value, @Opt final Then then) {
        super(then);
    ...
    public Moves eval(final Context context) {
        ...
        final ActionSetTemp actionTemp = new ActionSetTemp(this.value.eval(context));
        final Move move = new Move(actionTemp);
