...
public final class SwapPlayers extends Effect
{
    ...
    public SwapPlayers(@And @Or final IntFunction player1, @And @Or final RoleType role1, @And @Or2 final IntFunction player2, @And @Or2 final RoleType role2, @Opt final Then then) {
        super(then);
