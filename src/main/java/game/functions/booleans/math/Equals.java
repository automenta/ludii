...
public final class Equals extends BaseBooleanFunction
{
    ...
    public Equals(final IntFunction valueA, @Or final IntFunction valueB, @Or final RoleType roleB) {
        int numNonNull2 = 0;
        if (valueB != null) {
            ++numNonNull2;
        }
    ...
    public Equals(final RegionFunction regionA, final RegionFunction regionB) {
        this.valueA = null;
        this.valueB = null;
    ...
    public String toString() {
        String str = "";
        if (this.regionA == null) {
            str = str + "Equal(" + this.valueA + ", " + this.valueB + ")";
        }
        else {
            str = str + "Equal(" + this.regionA + ", " + this.regionB + ")";
        }
        return str;
    }
