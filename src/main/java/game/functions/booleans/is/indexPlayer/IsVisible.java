...
@Hide
public final class IsVisible extends BaseBooleanFunction
{
    ...
    public IsVisible(@Opt final SiteType type, final IntFunction locn, @Or final IntFunction indexPlayer, @Or final RoleType role) {
    ...
    public boolean eval(final Context context) {
        ...
        return cs.isVisible(site, this.playerId.eval(context), this.type);
    }
    
    @Override
    public String toString() {
        return "IsVisible(" + this.playerId + "," + this.locationId + ")";
    }
