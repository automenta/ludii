...
@Hide
public final class IsInvisible extends BaseBooleanFunction
{
    ...
    public IsInvisible(@Opt final SiteType type, final IntFunction locn, @Or final IntFunction indexPlayer, @Or final RoleType role) {
    ...
    public boolean eval(final Context context) {
        ...
        return cs.isInvisible(site, this.playerId.eval(context), this.type);
    }
    
    @Override
    public String toString() {
        return "IsInvisible(" + this.playerId + "," + this.locationId + ")";
    }
