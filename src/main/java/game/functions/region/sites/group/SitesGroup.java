...
public final class SitesGroup extends BaseRegionFunction
{
    ...
    public SitesGroup(@Opt final SiteType type, @Name final IntFunction at, @Opt final Direction directions, @Opt @Name final BooleanFunction If) {
    ...
    public Region eval(final Context context) {
        ...
        return new Region(groupSites.toArray());
    }
