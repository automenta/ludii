...
public class Intersection extends BaseRegionFunction
{
    ...
    public Intersection(final RegionFunction region1, final RegionFunction region2) {
    ...
    public Intersection(final RegionFunction[] regions) {
        this.precomputedRegion = null;
        this.region1 = null;
        this.region2 = null;
    ...
    public Region eval(final Context context) {
        ...
        for (int i = 1; i < this.regions.length; ++i) {
            sites3.intersection(new Region(this.regions[i].eval(context)));
        }
        return sites3;
    }
