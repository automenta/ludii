...
public final class SizesGroup extends BaseIntArrayFunction
{
    ...
    public SizesGroup(@Opt final SiteType type, @Opt final Direction directions, @Opt @Or final RoleType role, @Opt @Or @Name final IntFunction of, @Opt @Or @Name final BooleanFunction If, @Opt @Name final IntFunction min) {
        this.type = type;
