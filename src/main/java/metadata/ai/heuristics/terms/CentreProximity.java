...
public class CentreProximity extends HeuristicTerm
{
    ...
    public CentreProximity(@Name @Opt final HeuristicTransformation transformation, @Name @Opt final Float weight, @Name @Opt final Pair[] pieceWeights) {
    ...
    private void computeMaxDist(final Game game) {
    ...
    public static boolean isApplicableToGame(final Game game) {
        ...
        return components.length > 1 && game.distancesToCentre() != null;
    }
