...
public class SidesProximity extends HeuristicTerm
{
    ...
    public SidesProximity(@Name @Opt final HeuristicTransformation transformation, @Name @Opt final Float weight, @Name @Opt final Pair[] pieceWeights) {
    ...
    public static boolean isApplicableToGame(final Game game) {
        ...
        return components.length > 1 && game.distancesToSides() != null;
    }
