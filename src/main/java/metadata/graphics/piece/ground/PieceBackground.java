...
public class PieceBackground implements GraphicsItem
{
    ...
    public PieceBackground(@Opt final RoleType roleType, @Opt final String pieceName, @Opt @Name final Integer state, @Name final String background, @Opt @Name final Colour fillColour, @Opt @Name final Colour edgeColour, @Opt @Name final Float scale) {
