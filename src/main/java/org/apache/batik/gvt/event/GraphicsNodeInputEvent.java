...
public abstract class GraphicsNodeInputEvent extends GraphicsNodeEvent
{
    ...
    protected GraphicsNodeInputEvent(final GraphicsNode source, final int id, final long when, final int modifiers, final int lockState) {
        super(source, id);
        this.when = when;
    ...
    protected GraphicsNodeInputEvent(final GraphicsNode source, final InputEvent evt, final int lockState) {
