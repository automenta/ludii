...
public class SVGCSSEngine extends CSSEngine
{
    ...
    public SVGCSSEngine(final Document doc, final ParsedURL uri, final ExtendedParser p, final CSSContext ctx) {
        super(doc, uri, p, SVGCSSEngine.SVG_VALUE_MANAGERS, SVGCSSEngine.SVG_SHORTHAND_MANAGERS, null, null, "style", null, "class", true, null, ctx);
    ...
    public SVGCSSEngine(final Document doc, final ParsedURL uri, final ExtendedParser p, final ValueManager[] vms, final ShorthandManager[] sms, final CSSContext ctx) {
        super(doc, uri, p, mergeArrays(SVGCSSEngine.SVG_VALUE_MANAGERS, vms), mergeArrays(SVGCSSEngine.SVG_SHORTHAND_MANAGERS, sms), null, null, "style", null, "class", true, null, ctx);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    
    protected SVGCSSEngine(final Document doc, final ParsedURL uri, final ExtendedParser p, final ValueManager[] vms, final ShorthandManager[] sms, final String[] pe, final String sns, final String sln, final String cns, final String cln, final boolean hints, final String hintsNS, final CSSContext ctx) {
        super(doc, uri, p, mergeArrays(SVGCSSEngine.SVG_VALUE_MANAGERS, vms), mergeArrays(SVGCSSEngine.SVG_SHORTHAND_MANAGERS, sms), pe, sns, sln, cns, cln, hints, hintsNS, ctx);
        this.lineHeightIndex = this.fontSizeIndex;
    }
    
    protected static ValueManager[] mergeArrays(final ValueManager[] a1, final ValueManager[] a2) {
        final ValueManager[] result = new ValueManager[a1.length + a2.length];
        System.arraycopy(a1, 0, result, 0, a1.length);
        System.arraycopy(a2, 0, result, a1.length, a2.length);
        return result;
    }
    
    protected static ShorthandManager[] mergeArrays(final ShorthandManager[] a1, final ShorthandManager[] a2) {
        final ShorthandManager[] result = new ShorthandManager[a1.length + a2.length];
        System.arraycopy(a1, 0, result, 0, a1.length);
        System.arraycopy(a2, 0, result, a1.length, a2.length);
        return result;
    }
