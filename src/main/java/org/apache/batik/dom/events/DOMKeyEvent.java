...
public class DOMKeyEvent extends DOMUIEvent
{
    ...
    public void initKeyEvent(final String typeArg, final boolean canBubbleArg, final boolean cancelableArg, final boolean ctrlKeyArg, final boolean altKeyArg, final boolean shiftKeyArg, final boolean metaKeyArg, final int keyCodeArg, final int charCodeArg, final AbstractView viewArg) {
