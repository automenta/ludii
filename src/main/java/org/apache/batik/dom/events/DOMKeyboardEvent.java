...
public class DOMKeyboardEvent extends DOMUIEvent implements KeyboardEvent
{
    ...
    @Override
    public void initKeyboardEvent(final String typeArg, final boolean canBubbleArg, final boolean cancelableArg, final AbstractView viewArg, final String keyIdentifierArg, final int keyLocationArg, final String modifiersList) {
    ...
    @Override
    public void initKeyboardEventNS(final String namespaceURIArg, final String typeArg, final boolean canBubbleArg, final boolean cancelableArg, final AbstractView viewArg, final String keyIdentifierArg, final int keyLocationArg, final String modifiersList) {
