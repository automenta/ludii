...
public class EvalPlayoutImplementations
{
    ...
    public static void main(final String[] args) {
        final CommandLineArgParse argParse = new CommandLineArgParse(true, "Evaluate playing strength of MCTS agents with different playout implementations against each other.");
        ...
        final EvalPlayoutImplementations eval = new EvalPlayoutImplementations(argParse.getValueBool("--useGUI"), argParse.getValueInt("--max-wall-time"));
