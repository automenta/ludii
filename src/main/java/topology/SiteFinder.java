...
public final class SiteFinder
{
    public static TopologyElement find(final Board board, final String coord, final SiteType type) {
        if ((type == null && board.defaultSite() == SiteType.Cell) || (type != null && type == SiteType.Cell)) {
        ...
        else if ((type == null && board.defaultSite() == SiteType.Vertex) || (type != null && type == SiteType.Vertex)) {
